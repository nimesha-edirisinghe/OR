...
const InitialUploadPanel: FC<Props> = ({
  ...
  const formattedDescription = `This will permanently update the current ${
    isForecastAlert ? 'forecasted values' : 'replenishment schedules'
  }. Are you sure you want to submit?`;
  return (
    <VStack w="full" bg={ocean_blue_600} align="start" spacing="8px">
      <AppText size="h3Semibold">File Upload</AppText>
      <AppText size="body2">{formattedDescription}</AppText>
