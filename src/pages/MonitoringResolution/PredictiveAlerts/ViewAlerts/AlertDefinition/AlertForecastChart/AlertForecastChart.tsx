...
import { AlertForecastChartResponseDataI, alertForecastChartType } from 'types/alertConfig';
...
interface AlertForecastChartProps {
  reportData: AlertForecastChartResponseDataI[];
...
const AlertForecastChart: FC<AlertForecastChartProps> = ({
  reportData,
  selectedChartType,
  ...
  const predictorList = alertState.predictorList;
  ...
  const RenderLegend = (props: any) => {
    const { cgn } = props;
    return (
      <HStack w="full" spacing="20px" pl="30px" mb="5px" position={'absolute'} bottom={7}>
        <HStack>
          <>
            <Box
              w="12px"
...
export default AlertForecastChart;
