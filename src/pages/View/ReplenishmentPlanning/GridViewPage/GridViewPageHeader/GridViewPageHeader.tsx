...
import { blue_500, neutral_100, neutral_200, neutral_300, ocean_blue_400, ocean_blue_600, red_500 } from 'theme/colors';
...
const GridViewPageHeader: FC<Props> = () => {
  ...
  const onRefreshHandler = () => {
    dispatch(getReplenishmentExpandedSkuDataRequest({}));
  };
...
export default GridViewPageHeader;
